...
g++ -O3 -I /usr/include/eigen3 -march=native -ffast-math -fopenmp kernel_svm_openmp.cpp -o kernel_svm_openmp
# echo "Compiling MPI version..."
# mpic++ kernel_svm_mpi.cpp -o kernel_svm_mpi -I /usr/include/eigen3 -std=c++17 -O3 -Wall

rows_values=(200 500 1000 2000 5000)
thread_values=(2 4 8 12)
